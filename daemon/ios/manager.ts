    ...
    return {
      ...
      data: {
        ...
        ...(out.length === 0
          ...
          : anyIdle
            ? { note: "connected:false means the runner is not dialed in — it auto-connects on the next verb (e.g. 'interceptor ios tree --on <name>'). Keep the phone unlocked & awake while driving." }
            : {}),
      },
    }
  }
